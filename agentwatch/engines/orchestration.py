...
class OrchestrationEngine:
    ...
    Architecture:
    - Planner decomposes goal into TaskGraph
    - Executor agents pick up ready tasks
    - Verifier validates outputs
    - Memory agent provides context
    - All communication via typed AgentMessages + event bus
    """
    ...
    async def delegate_task(
        ...
        async with self._dispatch_lock:
            ...
            # Pick executor with most capabilities matching task
            executor = executors[0]  # Simple: first available
