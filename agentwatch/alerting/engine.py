...
class AlertingEngine:
    ...
    async def alert_smart_alert(self, alert_text: str, dashboard_link: str) -> dict[str, bool]:
        ...
        payload = {
            "slack": {
                "text": "Smart Alert Intervention Required",
                "blocks": [
                    {"type": "section", "text": {"type": "mrkdwn", "text": f"*Smart Alert: Intervention Required*"}},
                    {"type": "section", "text": {"type": "mrkdwn", "text": alert_text}},
                    {"type": "section", "text": {"type": "mrkdwn", "text": f"<{dashboard_link}|Review on Dashboard>"}}
                ]
            }
        }
        sent = {"slack": False, "pagerduty": False}
